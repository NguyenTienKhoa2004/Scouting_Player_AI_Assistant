"""Adapter from MatchMind's canonical events to socceraction SPADL."""
...
from matchmind.data.ingestion.normalizer import CanonicalEvent
...
class SpadlAction:
    """One socceraction SPADL row plus MatchMind trace/context fields."""
