...
from matchmind.ml.dependencies import (  # noqa: E402
...
class RuntimeDependencyTests(unittest.TestCase):
    ...
    @patch("matchmind.ml.dependencies.platform.machine", return_value="x86_64")
    @patch("matchmind.ml.dependencies.platform.release", return_value="test")
    @patch("matchmind.ml.dependencies.platform.system", return_value="TestOS")
    @patch("matchmind.ml.dependencies.platform.python_version", return_value="3.12.0")
    @patch(
        "matchmind.ml.dependencies.platform.python_implementation",
        return_value="CPython",
    )
    @patch(
        "matchmind.ml.dependencies.distribution_version",
        side_effect={
            "numpy": "2.3.3",
            "scikit-learn": "1.9.1",
            "xgboost": "3.4.1",
    ...
    @patch("matchmind.ml.dependencies.distributions")
    ...
    @patch("matchmind.ml.dependencies.capture_runtime_dependencies")
